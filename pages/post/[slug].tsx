  ...
  return (
    <>
        ...
        <article className='w-full mx-auto p-5 bg-secondaryColor/10'>
            <h1 className='
            font-titleFont font-medium text-[32px] text-primary border-b-[1px]
            border-b-cyan-800 mt-10 mb-3'>
                 ...
                 <div className='flex items-center gap-2'>
                    ...
                    - Published at {" "} {new Date(post.publishedAt).toLocaleDateString()} </p>
                 </div>

                 <div className='mt-10'>
                    <PortableText 
                    dataset={process.env.NEXT_PUBLIC_SANITY_DATASET || "production"}
                    projectId = {process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || "4e01x7u0"}
                 ...
                 {
                    submitted ? (
                    <div className='flex flex-col items-center gap-2 p-10 my-10 bg-bgColor
                    text-white mx-auto'>
                       <h1 className='text-2xl font-bold'>Thank you for sharing your Comment! </h1>
                 ...
                 <div>
                    ...
                    className='mt-7 flex flex-col gap-6'>
                        <label className='flex flex-col'>
                          ...
                          <input
                            ...
                            shadow-secondaryColor py-1 px-4 outline-none focus-within:shadow-xl shadow-secondaryColor'
                            />
                            {/* Error name */}
                            {errors.name && (
                    ...
                    shadow-lg space-y-2'>
                        ...
                        {post.comments.map((comment) => (
                            <div key={comment._id}>
                                <p><span className='text-secondaryColor'>
                                    {comment.name}
                                    </span> {" "}
                                    {comment.comment}</p>
                            </div>
